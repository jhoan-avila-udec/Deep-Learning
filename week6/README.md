...
> **Tarea:**  Aplicar métodos de regularización para mejorar la generalización de una red neuronal, comparando un modelo base (sin regularización) frente a un modelo regularizado.

> [!TIP]
> **Solución Actividad 6:** Codigo ejecutado en Google Colab y exportado en formato .ipynb (week6/Actividad6.ipynb) con el analisis de la realizacion de una Red Neuronal Modelo Base vs Modelos con Regularización en el aprendizaje en anotaciones (Markdown).
